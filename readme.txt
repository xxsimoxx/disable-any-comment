...
Download link:      https://github.com/xxsimoxx/disable-any-comment/releases/download/v1.0.4/disable-any-comment-1.0.4.zip
License:            GPLv2
...
This plugin is made specifically to use with ClassicPress.